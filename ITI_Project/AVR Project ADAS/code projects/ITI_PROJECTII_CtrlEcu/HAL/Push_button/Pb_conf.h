...
/**
 * connection of Pb 1	-- GearBox INT2
*/
#define Pb1_PORT    DIO_PORTB
#define Pb1_PIN     DIO_PIN2

/**
 * connection of Pb 2	-- SL INT0
*/
#define Pb2_PORT    DIO_PORTD
#define Pb2_PIN     DIO_PIN2

/**
 * connection of Pb 3	-- CCS INT1
*/
#define Pb3_PORT    DIO_PORTD
#define Pb3_PIN     DIO_PIN3
